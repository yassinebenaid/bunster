...
var errorHandlingTestCases = []struct {
	...
	{"Simple Commands", []errorHandlingTestCase{
		{`|`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`>`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`>>`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`1>>`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`<<<`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`1<<<`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`1>`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`1<`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`1>&`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`1<&`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`&& cmd2`, "syntax error: `|` is a special character and cannot be used as a command name."},
		{`|| cmd2`, "syntax error: `|` is a special character and cannot be used as a command name."},
