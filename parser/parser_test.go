...
var errorHandlingTestCases = []struct {
	...
	{"Simple Commands", []errorHandlingTestCase{
		...
		24: {`cmd ; || cmd2`, "syntax error: `||` has a special meaning here and cannot be used as a command name. (line: 1, column: 7)"},
		25: {`cmd ; && cmd2`, "syntax error: `&&` has a special meaning here and cannot be used as a command name. (line: 1, column: 7)"},
		26: {`cmd ; | cmd2`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 7)"},
		27: {`cmd || ; cmd2`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 8)"},
		28: {`cmd && ; cmd2`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 8)"},
		29: {`cmd | ; cmd2`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 7)"},
