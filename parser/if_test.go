...
var ifErrorHandlingCases = []errorHandlingTestCase{
	...
	{`if; then`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 3)"},
	...
	{`if; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 3)"},
	...
	{`if cmd;then cmd;else; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 21)"},

	{`if cmd|;then cmd; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 8)"},
	{`if cmd| |;then cmd; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 9)"},
	{`if cmd;then cmd|; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 17)"},
	{`if cmd;then cmd| |; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 18)"},
	{`if cmd; then cmd; elif cmd|;then cmd; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 28)"},
	{`if cmd; then cmd; elif cmd| |;then cmd; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 29)"},
	{`if cmd; then cmd; elif cmd;then cmd|; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 37)"},
	{`if cmd; then cmd; elif cmd;then cmd| |; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 38)"},
	{`if cmd; then cmd; else cmd|; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 28)"},
	{`if cmd; then cmd; else cmd| |; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 29)"},

	{`then`, "syntax error: `then` is a reserved keyword, cannot be used a command name. (line: 1, column: x)"},
	{`elif`, "syntax error: `elif` is a reserved keyword, cannot be used a command name. (line: 1, column: x)"},
	{`else`, "syntax error: `else` is a reserved keyword, cannot be used a command name. (line: 1, column: x)"},
	{`fi`, "syntax error: `fi` is a reserved keyword, cannot be used a command name. (line: 1, column: x)"},
}
