...
var ifErrorHandlingCases = []errorHandlingTestCase{
	...
	{`if cmd;then cmd;else fi`, "syntax error: expected command list after `else`. (line: 1, column: x)"},
	{`if cmd;then cmd;else; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},

	{`if cmd|;then cmd; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd| |;then cmd; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd;then cmd|; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd;then cmd| |; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd; then cmd; elif cmd|;then cmd; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd; then cmd; elif cmd| |;then cmd; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd; then cmd; elif cmd;then cmd|; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd; then cmd; elif cmd;then cmd| |; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd; then cmd; else cmd|; fi`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
	{`if cmd; then cmd; else cmd| |; fi`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: x)"},
