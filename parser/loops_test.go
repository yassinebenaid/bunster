...
var loopsErrorHandlingCases = []errorHandlingTestCase{
	...
	{`until; do`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 6)"},
	...
	{`until; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 6)"},
	...
	{`until cmd |;do cmd; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 12)"},
	{`until cmd | &;do cmd; done`, "syntax error: `&` has a special meaning here and cannot be used as a command name. (line: 1, column: 13)"},
	{`until cmd;do cmd && | ; done`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 21)"},
	{`until cmd;do cmd &&; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 20)"},
