...
var loopsErrorHandlingCases = []errorHandlingTestCase{
	...
	{`while; do`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 6)"},
	...
	{`while; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 6)"},
	...
	{`while cmd |;do cmd; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 12)"},
	{`while cmd | &;do cmd; done`, "syntax error: `&` has a special meaning here and cannot be used as a command name. (line: 1, column: 13)"},
	{`while cmd;do cmd && | ; done`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 21)"},
	{`while cmd;do cmd &&; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 20)"},

	// UNTIL LOOPS
	{`until`, "syntax error: expected command list after `until`. (line: 1, column: 1)"},
	{`until do`, "syntax error: expected command list after `until`. (line: 1, column: 1)"},
	{`until; do`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},
	{`until cmd; done`, "syntax error: expected `do`, found `done`. (line: 1, column: 1)"},
	{`until done`, "syntax error: expected command list after `until`. (line: 1, column: 1)"},
	{`until; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},
	{`until cmd;do done`, "syntax error: expected command list after `do`. (line: 1, column: 1)"},
	{`until cmd;do cmd`, "syntax error: expected `done` to close `until` loop. (line: 1, column: 1)"},
	{`until cmd;do cmd; done arg`, "syntax error: unexpected token `arg`. (line: 1, column: 1)"},
	{`until cmd;do cmd; done <in >out <<<etc arg`, "syntax error: unexpected token `arg`. (line: 1, column: 1)"},
	{`until cmd |;do cmd; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},
	{`until cmd | &;do cmd; done`, "syntax error: `&` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},
	{`until cmd;do cmd && | ; done`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},
	{`until cmd;do cmd &&; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},

	// FOR LOOPS (over positional arguments)
	{`for`, "syntax error: expected identifier after `for`. (line: 1, column: 1)"},
	{"for \n var do done", "syntax error: expected identifier after `for`. (line: 2, column: 1)"},
	{`for do`, "syntax error: expected identifier after `for`. (line: 1, column: 1)"},
	{`for; do`, "syntax error: expected identifier after `for`. (line: 1, column: 1)"},
	{`for var done`, "syntax error: expected `do`, found `done`. (line: 1, column: 1)"},
	{`for var \do done`, "syntax error: expected `do`, found `\\d`. (line: 1, column: 1)"},
	{`for done`, "syntax error: expected identifier after `for`. (line: 1, column: 1)"},
	{`for var do done`, "syntax error: expected command list after `do`. (line: 1, column: 1)"},
	{`for var do cmd `, "syntax error: expected `done` to close `for` loop. (line: 1, column: 1)"},
	{`for var do cmd \done`, "syntax error: expected `done` to close `for` loop. (line: 1, column: 1)"},
	{`for var do cmd; done arg`, "syntax error: unexpected token `arg`. (line: 1, column: 1)"},
	{`for var do cmd; done <in >out <<<etc arg`, "syntax error: unexpected token `arg`. (line: 1, column: 1)"},
	{`for \var do cmd; done`, "syntax error: expected identifier after `for`. (line: 1, column: 1)"},
	{`for var foo do cmd; done`, "syntax error: expected `do`, found `foo`. (line: 1, column: 1)"},
	{`for invalid-var-name do cmd; done`, "syntax error: expected `do`, found `-`. (line: 1, column: 1)"},
	{`for n in; do cmd; done`, "syntax error: missing operand after `in`. (line: 1, column: 1)"},
	{"for n in foo \n bar; do cmd; done", "syntax error: expected `do`, found `bar`. (line: 2, column: 1)"},
	{"for n in &; do cmd; done", "syntax error: unexpected token `&`. (line: 1, column: 1)"},
	{"for n in foo &; do cmd; done", "syntax error: unexpected token `&`. (line: 1, column: 1)"},
	{`for n do cmd |; done`, "syntax error: `;` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},
	{`for n do cmd | |; done`, "syntax error: `|` has a special meaning here and cannot be used as a command name. (line: 1, column: 1)"},
