...
var conditionalsErrorHandlingCases = []errorHandlingTestCase{
	...
	{`if cmd; fi`, "syntax error: `fi` is a reserved keyword, cannot be used a command name."},
	{`if fi`, "syntax error: `fi` is a reserved keyword, cannot be used a command name."},
