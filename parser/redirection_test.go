		...
		Statements: []ast.Statement{
			ast.Command{
				...
				Args: []ast.Expression{
					...
					{Src: "1", Method: ">", Dst: ast.SimpleExpansion("var")},
		...
		Statements: []ast.Statement{
			ast.Command{
				...
				Args: []ast.Expression{
					...
					{Method: "&>", Dst: ast.SimpleExpansion("var")},
		...
		Statements: []ast.Statement{
			ast.Command{
				...
				Args: []ast.Expression{
					...
					{Src: "1", Method: ">&", Dst: ast.SimpleExpansion("FD")},
					{Src: "3", Method: ">&", Dst: ast.SimpleExpansion("FD")},
				},
			},
		},
	}},
		...
		Statements: []ast.Statement{
			ast.Command{
				...
				Args: []ast.Expression{
					...
					{Src: "0", Method: "<&", Dst: ast.SimpleExpansion("FD")},
		...
		Statements: []ast.Statement{
			ast.Command{
				...
				Args: []ast.Expression{
					...
					{Src: "0", Method: "<<<", Dst: ast.Word("foo")},
					{Src: "0", Method: "<<<", Dst: ast.Word("foo-bar")},
					{Src: "0", Method: "<<<", Dst: ast.SimpleExpansion("var")},
