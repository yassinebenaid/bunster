...
var redirectionErrorHandlingCases = []errorHandlingTestCase{
	{`cmd >`, "syntax error: a redirection operand was not provided after the `>`. (line: 1)"},
	{`cmd > >file.txt`, "syntax error: a redirection operand was not provided after the `>`. (line: 1)"},
	{`cmd >>`, "syntax error: a redirection operand was not provided after the `>>`. (line: 1)"},
	{`cmd >> >>foo`, "syntax error: a redirection operand was not provided after the `>>`. (line: 1)"},
	{`cmd >& `, "syntax error: a redirection operand was not provided after the `>&`. (line: 1)"},
	{`cmd >& >&$foo`, "syntax error: a redirection operand was not provided after the `>&`. (line: 1)"},

	{`cmd 1>`, "syntax error: a redirection operand was not provided after the `>`. (line: 1)"},
	{`cmd 1>1>x`, "syntax error: a redirection operand was not provided after the `>`. (line: 1)"},
	{`cmd 1>>`, "syntax error: a redirection operand was not provided after the `>>`. (line: 1)"},
	{`cmd 1>>1>>x`, "syntax error: a redirection operand was not provided after the `>>`. (line: 1)"},
	{`cmd 1>& `, "syntax error: a redirection operand was not provided after the `>&`. (line: 1)"},
	{`cmd 1>&1>&2`, "syntax error: a redirection operand was not provided after the `>&`. (line: 1)"},

	{`cmd >|`, "syntax error: a redirection operand was not provided after the `>|`. (line: 1)"},
	{`cmd >|>|foo`, "syntax error: a redirection operand was not provided after the `>|`. (line: 1)"},
	{`cmd 1>|`, "syntax error: a redirection operand was not provided after the `>|`. (line: 1)"},
	{`cmd 1>|2>|foo`, "syntax error: a redirection operand was not provided after the `>|`. (line: 1)"},

	{`cmd <`, "syntax error: a redirection operand was not provided after the `<`. (line: 1)"},
	{`cmd < <foo`, "syntax error: a redirection operand was not provided after the `<`. (line: 1)"},
	{`cmd 1<`, "syntax error: a redirection operand was not provided after the `<`. (line: 1)"},
	{`cmd 1<1<`, "syntax error: a redirection operand was not provided after the `<`. (line: 1)"},
	{`cmd 1<&`, "syntax error: a redirection operand was not provided after the `<&`. (line: 1)"},
	{`cmd 1<&2<foo`, "syntax error: a redirection operand was not provided after the `<&`. (line: 1)"},

	{`cmd &>`, "syntax error: a redirection operand was not provided after the `&>`. (line: 1)"},
	{`cmd &>12>foo`, "syntax error: a redirection operand was not provided after the `&>`. (line: 1)"},

	{`cmd <<<`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1)"},
	{`cmd <<<<<<foo`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1)"},
	{`cmd 2<<<`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1)"},
	{`cmd <<<2<<<foo`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1)"},
}
