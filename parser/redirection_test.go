...
var redirectionTests = []testCase{
	...
	{`cmd>&1 arg >&2 arg>&3 arg345>&4 5>&6 985 >&19 12.34>& 7 8>& 9`, ast.Script{
		Statements: []ast.Node{
			ast.Command{
				Name: ast.Word("cmd"),
				Args: []ast.Node{
					...
					{Src: ast.FileDescriptor("1"), Method: ">&", Dst: ast.FileDescriptor("19")},
					{Src: ast.FileDescriptor("1"), Method: ">&", Dst: ast.FileDescriptor("7")},
					{Src: ast.FileDescriptor("8"), Method: ">&", Dst: ast.FileDescriptor("9")},
				},
			},
		},
	}},
	{`cmd<'file.ext' arg < file</foo/bar arg123<foo 3<bar 928 <bar 282 <&123 <&3 4<&5 6<& 7`, ast.Script{
		Statements: []ast.Node{
			ast.Command{
				Name: ast.Word("cmd"),
				Args: []ast.Node{
					...
					{Src: ast.FileDescriptor("0"), Method: "<&", Dst: ast.FileDescriptor("123")},
					{Src: ast.FileDescriptor("0"), Method: "<&", Dst: ast.FileDescriptor("3")},
					{Src: ast.FileDescriptor("4"), Method: "<&", Dst: ast.FileDescriptor("5")},
					{Src: ast.FileDescriptor("6"), Method: "<&", Dst: ast.FileDescriptor("7")},
				},
			},
		},
	}},
