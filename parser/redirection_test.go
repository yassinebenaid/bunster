...
var redirectionErrorHandlingCases = []errorHandlingTestCase{
	...
	{`cmd < <foo`, "syntax error: a redirection operand was not provided after the `<`. (line: 1, column: 7)"},
	{`cmd 1<`, "syntax error: a redirection operand was not provided after the `<`. (line: 1, column: 7)"},
	{`cmd 1<1<`, "syntax error: a redirection operand was not provided after the `<`. (line: 1, column: 6)"},
	{`cmd 1<&`, "syntax error: a redirection operand was not provided after the `<&`. (line: 1, column: 6)"},
	{`cmd 1<&2<foo`, "syntax error: a redirection operand was not provided after the `<&`. (line: 1, column: 6)"},

	{`cmd &>`, "syntax error: a redirection operand was not provided after the `&>`. (line: 1, column: 6)"},
	{`cmd &>12>foo`, "syntax error: a redirection operand was not provided after the `&>`. (line: 1, column: 6)"},

	{`cmd <<<`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1, column: 6)"},
	{`cmd <<<<<<foo`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1, column: 6)"},
	{`cmd 2<<<`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1, column: 6)"},
	{`cmd <<<2<<<foo`, "syntax error: a redirection operand was not provided after the `<<<`. (line: 1, column: 6)"},
}
