...
func TestLexer(t *testing.T) {
	testCases := []struct {
		...
		{`**`, []token.Token{{Type: token.EXPONENTIATION, Literal: `**`}}},
		{`/`, []token.Token{{Type: token.SLASH, Literal: `/`}}},
		{`%`, []token.Token{{Type: token.PERCENT, Literal: `%`}}},
		{`%=`, []token.Token{{Type: token.PERCENT_ASSIGN, Literal: `%=`}}},
		...
		{`|=`, []token.Token{{Type: token.PIPE_ASSIGN, Literal: `|=`}}},
		{`&`, []token.Token{{Type: token.AMPERSAND, Literal: `&`}}},
		{`&=`, []token.Token{{Type: token.AMPERSAND_ASSIGN, Literal: `&=`}}},
		{`>>`, []token.Token{{Type: token.DOUBLE_GT, Literal: `>>`}}},
		{`>>=`, []token.Token{{Type: token.DOUBLE_GT_ASSIGN, Literal: `>>=`}}},
		{`<<`, []token.Token{{Type: token.DOUBLE_LT, Literal: `<<`}}},
		{`<<=`, []token.Token{{Type: token.DOUBLE_LT_ASSIGN, Literal: `<<=`}}},
