...
func TestLexer(t *testing.T) {
	testCases := []struct {
		...
		{`$$ $@ $? $# $! $_ $*`, []token.Token{
			...
			{Type: token.SPECIAL_VAR, Literal: "!", Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.SPECIAL_VAR, Literal: "_", Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.SPECIAL_VAR, Literal: "*", Line: 1, Position: 1},
		}},
		// Simple expansion
		...
		{`0123456789 abc1234 123.456 .123 123. 1.2.3 .abc 1.c 12.34abc`, []token.Token{
			...
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.WORD, Literal: `abc`, Line: 1, Position: 1},
			{Type: token.INT, Literal: `1234`, Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.FLOAT, Literal: `123.456`, Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.FLOAT, Literal: `.123`, Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.FLOAT, Literal: `123.`, Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.FLOAT, Literal: `1.2`, Line: 1, Position: 1},
			{Type: token.FLOAT, Literal: `.3`, Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.OTHER, Literal: `.`, Line: 1, Position: 1},
			{Type: token.WORD, Literal: `abc`, Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.FLOAT, Literal: `1.`, Line: 1, Position: 1},
			{Type: token.WORD, Literal: `c`, Line: 1, Position: 1},
			{Type: token.BLANK, Literal: ` `, Line: 1, Position: 1},
			{Type: token.FLOAT, Literal: `12.34`, Line: 1, Position: 1},
			{Type: token.WORD, Literal: `abc`, Line: 1, Position: 1},
		}},
		// Blank
		{"  	\t", []token.Token{
